            ...
            {this.state.config.editor.mode === "standalone" ?
                <SplitPane split="vertical" style={{ backgroundColor: "#333333"}} minSize={size.vertical.min} defaultSize={size.vertical.init}>
                    <Sidebar 
                        ...
                        onBugClick={() => this.openWindow(this.state.configObject.repository !== null ? `https://github.com/learnpack/learnpack/issues/new?assignees=&labels=&title=Excercise%20Bug&body=1.Exercise%20Name:%20${this.state.current.slug}%0D%0A%0D%0A2.Repository%20URL:%20${this.state.configObject.repository}`:`https://github.com/learnpack/learnpack/issues/new?title=Excercise%20Bug&body=1.Exercise%20Name:%20${this.state.current.slug}`)}
