            ...
            {this.state.config.editor.mode === "standalone" ?
                <SplitPane split="vertical" style={{ backgroundColor: "#333333"}} minSize={size.vertical.min} defaultSize={size.vertical.init}>
                    <Sidebar 
                        ...
                        onBugClick={() => this.openWindow(this.state.configObject.repository !== null ? `https://github.com/learnpack/learnpack/issues/new?assignees=&labels=&projects=learnpack/1&title=Excercise%20Bug:%20${this.state.current.slug}&body=Describe the bug:%0D%0A%0D%0A**1.%20Exercise%20Name:**%20${this.state.current.slug}%0D%0A%0D%0A**2.%20Repository%20URL:**%20${this.state.configObject.repository}`:`https://github.com/learnpack/learnpack/issues/new?title=Excercise%20Bug:%20${this.state.current.slug}&projects=learnpack/1&body=**1.20%Exercise%20Name:**%20${this.state.current.slug}`)}
